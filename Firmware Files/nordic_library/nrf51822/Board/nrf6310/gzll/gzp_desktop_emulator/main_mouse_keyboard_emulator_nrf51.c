...
#define BUTTON_SEND_KEYBOARD_DATA   NRFR_KEYBOARD_EP  ///< GPIO pin for reading from a button to emulate a keypress.
#define BUTTON_SEND_MOUSE_DATA      NRFR_MOUSE_EP  ///< GPIO pin for reading from a button to emulate a mouse movement.

#define LED_PORT NRF_GPIO_PORT_SELECT_PORT1
#define PAIRING_LED (8 + GZP_PAIRING_PIPE)
#define MOUSE_LED (8 + NRFR_MOUSE_EP)
#define KEYBOARD_LED (8 + NRFR_KEYBOARD_EP)
#define PAIRING_SUCCESS_LED 11
#define PAIRING_FAILED_LED 12
